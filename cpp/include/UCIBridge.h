...
public:
    ...
    FFISearchResult controlled_search(const FFISearchLimits& limits, const ::SearchControl& control, uint32_t hash_mb, bool morphy, rust::Str root_moves);
...
void search_engine_controlled(opera::SearchEngineWrapper& engine, const opera::FFISearchLimits& limits, const SearchControl& control, uint32_t hash_mb, bool morphy, rust::Str root_moves, opera::FFISearchResult& result);

bool board_previous_side_in_check(const opera::Board& board);
