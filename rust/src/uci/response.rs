        ...
        let result = match self {
            ...
            UCIResponse::Option {
                ...
                match option_type {
                    ...
                    OptionType::Spin { min: spin_min, max: spin_max } => {
            ...
            UCIResponse::Info {
                ...
                for field in additional {
                    match field {
                        ...
                        InfoField::CurrMoveNumber(cmn) => parts.push(format!("currmovenumber {}", cmn)),
...
mod tests {
    ...
    fn test_id_response() {
        ...
        let formatted = response.to_uci_string().expect("Should format successfully");
    ...
    fn test_spin_option_response() {
        ...
        assert_eq!(formatted, "option name Hash type spin default 128 min 1 max 8192");
    }
    ...
    fn test_check_option_response() {
        ...
        assert_eq!(formatted, "option name MorphyStyle type check default false");
    }
    ...
    fn test_bestmove_response() {
        let response = UCIResponse::best_move("e2e4")
            .ponder("e7e5")
            .build();
    ...
    fn test_response_formatter_batch() {
        ...
        let formatted = ResponseFormatter::format_batch(&responses)
            .expect("Should format batch successfully");
    ...
    fn test_response_formatter_collect() {
        ...
        assert_eq!(collected[0], "option name Hash type spin default 128 min 1 max 8192");
        assert_eq!(collected[1], "option name MorphyStyle type check default false");
    }
    ...
    fn test_string_option_response() {
        ...
        assert_eq!(formatted, "option name BookFile type string default book.bin");
    }
}