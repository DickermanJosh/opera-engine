...
impl RuntimeManager {
    ...
    pub fn block_on_with_timeout<F>(&self, future: F, timeout_ms: u64) -> UCIResult<F::Output>
    where
        F: std::future::Future,
    {
...
pub mod async_utils {
    ...
    pub async fn with_timeout<F>(future: F, timeout_ms: u64) -> UCIResult<F::Output>
    where
        F: std::future::Future,
    {
        let timeout_duration = Duration::from_millis(timeout_ms);
...
pub mod performance {
    ...
    impl PerformanceMonitor {
        ...
        pub async fn record_operation<T>(
            ...
            let total_duration = metrics.average_duration_ms
        ...
        pub async fn log_performance_summary(&self) {
            ...
            info!(
                ...
                min_duration_ms = if metrics.min_duration_ms == u64::MAX {
                    0
                } else {
        ...
        F: std::future::Future<Output = UCIResult<T>>,
    {
        ...
        monitor
            .record_operation(operation_name, record_result, duration_ms)
            .await;
...
mod tests {
    ...
    async fn test_safe_sleep() {
        ...
        async_utils::safe_sleep(Duration::from_millis(10))
            .await
            .unwrap();
    ...
    async fn test_with_timeout_success() {
        let result =
            async_utils::with_timeout(async { Ok::<&str, UCIError>("success") }, 1000).await;
    ...
    async fn test_with_timeout_failure() {
        let result =
            async_utils::with_timeout(async { sleep(Duration::from_millis(100)).await }, 50).await;
    ...
    async fn test_performance_monitor() {
        ...
        monitor
            .record_operation("test_op", Ok::<(), &dyn std::error::Error>(()), 100)
            .await;

        // Record failed operation
        let error = std::io::Error::new(std::io::ErrorKind::Other, "test error");
        monitor
            .record_operation::<()>("test_op", Err(&error), 200)
            .await;
